...
class CameraDriver:
    ...
    def get_region_of_interest(self) -> Tuple[Status, Union[BoundingPoly, None]]:
        status = Status(
            code=StatusCode.UNIMPLEMENTED,
    ...
    def get_delay(self) -> Tuple[Status, Union[FloatValue, None]]:
        status = Status(
            code=StatusCode.UNIMPLEMENTED,
    ...
    def get_brightness(self) -> Tuple[Status, Union[CameraSetting, None]]:
        status = Status(
            code=StatusCode.UNIMPLEMENTED,
    ...
    def get_exposure(self) -> Tuple[Status, Union[CameraSetting, None]]:
        status = Status(
            code=StatusCode.UNIMPLEMENTED,
            why="Brightness property not implemented for this camera.",
        )
    ...
    def get_focus(self) -> Tuple[Status, Union[CameraSetting, None]]:
        status = Status(
            code=StatusCode.UNIMPLEMENTED,
    ...
    def get_gain(self) -> Tuple[Status, Union[CameraSetting, None]]:
        status = Status(
            code=StatusCode.UNIMPLEMENTED,
    ...
    def get_gamma(self) -> Tuple[Status, Union[CameraSetting, None]]:
        status = Status(
            code=StatusCode.UNIMPLEMENTED,
    ...
    def get_hue(self) -> Tuple[Status, Union[CameraSetting, None]]:
        status = Status(
            code=StatusCode.UNIMPLEMENTED,
    ...
    def get_iris(self) -> Tuple[Status, Union[CameraSetting, None]]:
        status = Status(
            code=StatusCode.UNIMPLEMENTED,
    ...
    def get_saturation(self) -> Tuple[Status, Union[CameraSetting, None]]:
        status = Status(
            code=StatusCode.UNIMPLEMENTED,
    ...
    def get_sharpness(self) -> Tuple[Status, Union[CameraSetting, None]]:
        status = Status(
            code=StatusCode.UNIMPLEMENTED,
    ...
    def get_shutter(self) -> Tuple[Status, Union[CameraSetting, None]]:
        status = Status(
            code=StatusCode.UNIMPLEMENTED,
    ...
    def get_white_balance_bu(self) -> Tuple[Status, Union[CameraSetting, None]]:
        status = Status(
            code=StatusCode.UNIMPLEMENTED,
    ...
    def get_white_balance_rv(self) -> Tuple[Status, Union[CameraSetting, None]]:
        status = Status(
            code=StatusCode.UNIMPLEMENTED,
    ...
    def get_zoom(self) -> Tuple[Status, Union[CameraSetting, None]]:
        status = Status(
            code=StatusCode.UNIMPLEMENTED,
